...
import com.lezyo.fsm.pullrefresh.view.internal.BottomFlipLoadingLayout;
import com.lezyo.fsm.pullrefresh.view.internal.FlipLoadingLayout;
import com.lezyo.fsm.pullrefresh.view.internal.LoadingLayout;
import com.lezyo.fsm.pullrefresh.view.internal.RotateLoadingLayout;
import com.lezyo.fsm.pullrefresh.view.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs , boolean isBottom ,boolean dialogUe) {
		LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
				getPullToRefreshScrollDirection(), attrs , isBottom ,dialogUe);
...
//			mHeaderLayout.showSuccess();
	...
	private void init(Context context, AttributeSet attrs) {
		...
		boolean normalStyle= true;
		if (a.hasValue(R.styleable.PullToRefresh_needDialogueStyle)) {
			normalStyle = a.getBoolean(
					R.styleable.PullToRefresh_needDialogueStyle, true);
        }
		// We need to create now layouts now
	    mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a,false ,normalStyle);
		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a, true ,normalStyle);
		/**
		 * Styleables from XML
		 */
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs ,boolean isBottom ,boolean dialogUe) {
			switch (this) {
				case ROTATE:
				default:
					return new RotateLoadingLayout(context, mode, scrollDirection, attrs ,dialogUe);
				case FLIP:
					if ( isBottom ) {
						return new BottomFlipLoadingLayout(context, mode, scrollDirection, attrs,dialogUe);
					}else {
						return new FlipLoadingLayout(context, mode, scrollDirection, attrs ,dialogUe);
					}
...
//	public void setBottomPadding (boolean show) {
//		if (show) {
